...
class TestAnalysis(unittest.TestCase):
    ...
    def test_cpm(self):
        ...
        data = {
          "gene": ["Sobic.001G000200", "Sobic.001G000400 "],
          "ctr1": [338, 49],
          "ctr2": [324, 21],
          "ctr3": [246, 53],
        }
        ...
        result = {
          "gene": ["Sobic.001G000200", "Sobic.001G000400 "],
          "ctr1": [873385.01292, 126614.98708],
          "ctr2": [939130.434783, 60869.565217],
          "ctr3": [822742.474916, 177257.525084],
        }
        ...
        assert pro.CPM().apply(df).equals(res), "ERROR"
    ...
    def test_clinical_name(self):
        ...
        with self.assertRaises(SystemExit) as cm:
            pro.CheckElement(clinic).apply(clinical_options)
    ...
    def test_columnames_correct(self):
        ...
        assert pro.DataColumnames.apply(df) == ['calories', 'duration'], "incorrect columnnames"
    ...
    def test_subdataframe_col(self):
        ...
        with self.assertRaises(SystemExit) as cm:
            pro.DataProjectionList(test_list).apply(df)
    ...
    def test_metadata(self):
        ...
        class CheckElement():
            ...
            def __init__(self, element = ""):
                ...
                ut.checkArguments(arguments, inputs_params)
