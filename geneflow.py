...
def create_data_object(counts_dframe : ut.pd.DataFrame, obs_ = ut.pd.DataFrame(), vars_ = ut.pd.DataFrame(), log = Workflow(), unsdict = {} ):
    ...
    :rtype: DataObject
    """
    return dobj.DataObject(counts_dframe = counts_dframe, obs_ = obs_, vars_ = vars_, log = log, unsdict = unsdict )
